  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-[#E8F5F1] flex items-center justify-center">
      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-lg px-6 py-6 w-[400px]">
        ...
        {!showOtp ? (
          <>
            <h2 className="text-xl font-bold text-center mb-6 text-black">Welcome</h2>
            <form
              className="space-y-4"
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              ...
              <div className="mt-[-10px]">
                <label className="block text-sm text-left font-medium text-gray-700 mb-2 text-black">
                  Email
                </label>
                <input
                  type="email"
              ...
              <button
                type="submit"
                className="w-full bg-green-800 text-white py-2 rounded-md font-medium hover:bg-green-800 transition"
              >
                Sign in
              </button>
            </form>
          ...
          <>
            ...
            <p className="text-sm text-center text-blue-600 mb-4 mt-[-10px]">
